...
O módulo de autoria de cursos compostos por hypervideos tem o propósito de permitir que educadores construam materiais de estudo para enriquecer a base de dados do sistema proposto. Este módulo pode ser mais facilmente compreendido se dividido em dois níves: o nível conceitual e o nível de construção de hypervídeos.
