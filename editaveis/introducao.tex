...
No capítulo 3 é apresentado o desenvolvimento deste TCC, a arquitetura proposta para o sistema e os módulos de autoria de materiais e de visualização adaptativa, bem como uma visão geral das estratégias de teste e desenvolvimento utilizadas na contrução do software.
